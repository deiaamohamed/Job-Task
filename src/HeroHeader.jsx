...
function HeroHeader() {
    ...
    return (
        <>
            ...
            <header className="header_2 absolute top-0 left-0 right-0 z-50">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="hidden lg:flex items-center gap-6">
                            ...
                            <div className="flex items-center gap-2" style={{ marginTop: '-20px', marginBottom: '30px' }}>
                                <SocialLink href="https://x.com/PixonTech" icon="twitter" />
                                <SocialLink href="https://www.linkedin.com/company/pixon-tech/" icon="linkedin" />
                            </div>
                        </div>
            ...
            <header className="header_4 hidden lg:block fixed top-0 left-0 right-0 z-40 border-b border-white/10 -translate-y-full transition-transform duration-300" style={{ backgroundColor: '#3f3f3f' }} id="stickyHeader">
                    ...
                    >
                        ...
                        <nav className="mt-12">
                            <ul className="space-y-0">
                                <OffcanvasNavItem href="/" label="Home" active={true} />
                                ...
                                <OffcanvasNavItem href="/contact.html" label="Contact us" />
                            </ul>
                        </nav>
                        
                        {/* Social Icons */}
                        <div className="mt-8 flex gap-2">
                            <a href="https://x.com/PixonTech" className="w-10 h-10 rounded-full flex items-center justify-center text-[#1b57b3] transition-colors hover:text-white hover:bg-[#1b57b3]" style={{ backgroundColor: 'rgba(27,87,179,0.06)' }}>
                                <TwitterIconSmall />
                            </a>
                            <a href="https://www.linkedin.com/company/pixon-tech/" className="w-10 h-10 rounded-full flex items-center justify-center text-[#1b57b3] transition-colors hover:text-white hover:bg-[#1b57b3]" style={{ backgroundColor: 'rgba(27,87,179,0.06)' }}>
                                <LinkedinIconSmall />
                            </a>
                        </div>
                    ...
                    <div className="p-6">
                        ...
                        <nav className="mt-12">
                            <ul className="space-y-4">
                                <MobileNavItem href="/" label="Home" active={true} />
                                ...
                                <MobileNavItem href="/contact.html" label="Contact us" />
                            </ul>
                        </nav>
                    </div>
                </div>
